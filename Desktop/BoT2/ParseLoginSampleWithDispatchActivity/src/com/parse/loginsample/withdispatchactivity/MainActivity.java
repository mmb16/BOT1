...
public class MainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.bprofile).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
    ...
    findViewById(R.id.bsplit).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
    ...
    findViewById(R.id.bbuy).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
    ...
    findViewById(R.id.brequest).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
    ...
    findViewById(R.id.bpay).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
